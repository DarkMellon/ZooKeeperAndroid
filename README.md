...
However, judging from what I have experienced since I used the Android port version of ZooKeeper(about FOUR miserable month), I really DO NOT think using ZooKeeper in Android environment is a good idea. 